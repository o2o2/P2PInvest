...
public abstract class LoadingPage extends FrameLayout {
    ...
    LayoutParams params;
    private int state_current = STATE_LOADING;//默认情况下，当前状态是正在加载
    //2.提供4种不同的界面
    ...
    private void showPage(){
        //根据当前state_current的值，决定显示多个View
    ...
    public void show(){
        ...
        if(TextUtils.isEmpty(url)){
            ...
            loadImage();//修改state_current,并且决定加载哪个页面
            return;
        }
...
//                showSafePage();
    ...
    public enum ResultState{
        ERROR(2),EMPTY(3),SUCCESS(4);//3个对象
        //构造器
        int state;
